...
<!-- Published URL
https://www.servicenow.com/community/automation-engine-blog/how-to-migrate-from-scripted-integration-to-integration-hub-part/ba-p/2724867
-->
...
![Related Flows](blog5_images/related_flows.png)
...
[Content Filtering Rules](https://docs.servicenow.com/csh?topicname=configure-content-filtering-rules.html&version=latest) allow an administrator to define who can see certain spoke actions and who cannot - preventing unauthorised usage. 
...
Here is one screenshot providing an overview of the load passing through IntegrationHub, it will allow to drill down into specific spokes or actions, days of a week, protocols used etc. Another metric is successful vs. failing transactions.
